...
3. Die besten Treffer werden an den System-Prompt angehaengt.
...
- Wenn ein Dokument mehrere Themen enthaelt, sind mehrere kleine Chunks besser als ein riesiger Sammeltext.

## Ingest in dieser Version

Die Chunk-Erzeugung erfolgt im Admin-Bereich ueber Gemini:

- PDF wird als Datei an Gemini uebergeben
- TXT und Markdown werden als Text uebergeben
- Gemini liefert strukturierte Markdown-Chunks zurueck

## RAG-Einordnung

Die Wissensbasis bildet ein echtes RAG-Setup, aber ohne Embeddings:

- Retrieval: gewichtete Keyword-Suche ueber lokale Chunk-Dateien
...
Die Inhalte entstehen erst pro Instanz waehrend der Einrichtung und werden nicht versioniert.
